...
<p></p>
2.) Once you have created your virtual machine connect to it by using the public IP address the VM is setup with. You will connect using the remote desktop connection app. 
</p>
<br />
